...
![Start Page Cover](/assets/images/start-page.png.80.webp?w=1080&h=745)

- 项目地址：[start.zhaojiakun.com](https://start.zhaojiakun.com)
- 项目源码：[jiakun-zhao/start-page](https://github.com/jiakun-zhao/start-page)
- 视频地址：[BV18g4y1M76j](https://www.bilibili.com/video/BV18g4y1M76j)
...
- 在浏览器地址栏输入 `https://start.zhaojiakun.com/user/repo@version` （替换`user` 和 `repo` 和 `version` 字段，其中 `version` 字段可参考 [jsDelivr](https://www.jsdelivr.com/documentation#id-github) 的说明）。
...
- 同时修改：
  ...
  ```url
  https://start.zhaojiakun.com?engine=name&wallpaper=url
  ```
